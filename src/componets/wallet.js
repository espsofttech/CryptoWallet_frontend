                            ...
                            <div className="content-wrapper">
                                ...
                                <div className="row">
                                    <div className="col-md-12 pt-4">
                                        <div className="p-3">
                                            <span className="mb-2"> Your SLC Breakdown</span>
                                            <div className="form-body">
                                                <div className="boxcolor banner_blue mb-4 mt-2">
                                                    <div className="row">
                                                        <div className="col-lg-6"><h3>57.69 SLC ~ INR 576.90</h3></div>
                                                        ...
                                                        <div className="col-md-12">
                                                            <div className="card p-3">
                                                                <table className="text-black mt-2 mb-2" width="100%">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td className="text-right"><strong>1000.84 SLC </strong>~ INR10008.40</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td className="text-left">Total Staking</td>
                                                                            <td className="text-right"><strong>395 SLC </strong>~ INR3950.00</td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                                <hr className />
                                                                <table className="text-black mt-2 mb-2" width="100%">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td className="text-right"><strong> 237.49 SLC </strong>~ INR2374.90</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td className="text-left">Total Referral Earnings</td>
                                                                            <td className="text-right"><strong>0 SLC </strong>~ INR0.00</td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                                <hr className />
                                                                <table className="text-black mt-2 mb-2" width="100%">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td className="text-left">Current SLC Price</td>
